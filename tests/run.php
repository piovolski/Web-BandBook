...
expectSame(100, $snapshot['state']['obs_font_scale'], 'nowe wydarzenie ma domyślną wielkość tekstu OBS');
expectSame(85, $snapshot['state']['obs_bar_opacity'], 'nowe wydarzenie ma domyślną widoczność paska OBS');
...
$repo->setObsSetting($eventId, 'obs_font_scale', 120, $adminId);
$repo->setObsSetting($eventId, 'obs_bar_opacity', 70, $adminId);
$obsSnapshot = $repo->liveSnapshot($eventId, 'pl');
expectSame(120, $obsSnapshot['state']['obs_font_scale'], 'wielkość tekstu OBS zapisuje się w wydarzeniu');
expectSame(70, $obsSnapshot['state']['obs_bar_opacity'], 'widoczność paska OBS zapisuje się w wydarzeniu');
expectSame('text', $obsSnapshot['state']['output_mode'], 'OBS i ekran uczestników korzystają ze wspólnego trybu tekstu');
