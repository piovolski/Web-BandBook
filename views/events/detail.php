...
<div class="planner-layout" data-song-browser
    ...
    <aside class="planner-sidebar">
        ...
        <article class="panel share-card"><p class="eyebrow">Dla uczestników</p><h2>Stały ekran</h2><p class="muted">Jeden adres dla komputera projekcyjnego. Automatycznie pokazuje ostatnią część potwierdzoną jako „Teraz”, niezależnie od wydarzenia.</p><a class="button button-primary button-wide" target="_blank" rel="noopener" href="<?= e(url('screen')) ?>">Otwórz stały ekran ↗</a><button class="button button-ghost button-wide" type="button" data-copy-value="<?= e(url('screen')) ?>">Kopiuj stały adres</button><hr><p class="eyebrow">Transmisja OBS</p><p class="muted">Stała nakładka z tekstem na czarnym pasku u dołu obrazu.</p><a class="button button-primary button-wide" target="_blank" rel="noopener" href="<?= e(url('obs')) ?>">Podgląd stałej nakładki ↗</a><button class="button button-ghost button-wide" type="button" data-copy-value="<?= e(url('obs')) ?>">Kopiuj stały adres OBS</button><hr><p class="eyebrow">Tylko to wydarzenie</p><a class="button button-soft button-wide" target="_blank" rel="noopener" href="<?= e(url('public', ['token' => $event['public_token']])) ?>">Otwórz widok wydarzenia ↗</a><button class="button button-ghost button-wide" type="button" data-copy-value="<?= e(url('public', ['token' => $event['public_token']])) ?>">Kopiuj adres wydarzenia</button></article>
    </aside>
</div>
